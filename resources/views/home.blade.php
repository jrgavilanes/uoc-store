...
@section('content')
    ...
    <nav class="flex justify-between items-center w-[400px]">
        <ul class="flex gap-4 ">
            ...
            <li><a class="text-blue-300 hover:text-blue-500" href="/">Category 1</a></li>
            <li><a class="text-blue-300 hover:text-blue-500" href="/">Category 2</a></li>
        </ul>
        <ul>
            <li class="text-white hover:scale-105 cursor-pointer hover:bg-red-800 rounded-xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
